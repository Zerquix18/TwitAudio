...
class View
{
    ...
    /**
     * Should we allow robots? (i.e meta name="robots")
    ...
    public static function getTemplateOptions()
    {
        ...
        $global_helpers = array(
                'get_image'   => '\application\View::getImage',
                'get_style'   => '\application\View::getStyle',
                'get_script'  => '\application\View::getScript',
                'alert_error' => '\application\View::alertError',
                'alert_info'  => '\application\View::alertInfo',
                'show_verified_badge' => // ↓
                '\application\View::showVerifiedBadge'
            );
        $default_options = array(
                ...
                'group_options' => array(
                    ...
                    'helpers' => array(
                        ...
                        **/
                        'get_template' => '\application\View::getTemplate',
                        'get_partial'  => '\application\View::getPartial',
     ...
     */
    public static function getGroupTemplate($group, $bars = [])
    {
        //group/template
        ...
        * and other stuff.
        **/
        $default_bars  = self::getDefaultBars($group);
     ...
     * @return string
    **/
    public static function getTemplate($template, $bars = [])
    {
        // all the methods here have to have its namespace
        $options       = \application\View::getTemplateOptions();
     ...
     * @return string
    **/
    public static function getPartial($partial, $bars = [])
    {
        /**
     ...
     * @return array
    **/
    public static function getDefaultBars($group)
    {
        $options = self::getTemplateOptions();
        $result  = array();
        $result['header'] = array();
     ...
     */
    public static function exit404($group = 'main')
    {
        ob_end_clean();
        self::setTitle('Error 404');
        self::setPage('404');
        self::setRobots(false);
        echo self::getGroupTemplate("{$group}/404");
        exit;
    }
     ...
     */
    public static function alertError($error)
    {
     ...
     */
    public static function alertInfo($info)
    {
     ...
     * @param  string $number The string that comes from the database.
     *                      Must be 1 or 0
     * @return string
     */
    public static function showVerifiedBadge($number)
    {
        if ('1' !== $number) {
            return '';
        }
        return
            '<i class="fa fa-check verified" title="Verified account"></i>';
    }
}